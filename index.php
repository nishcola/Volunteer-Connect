...
<body class="text-bg-dark">
    ...
    <main>
        ...
        <div id="consentPopup" class="hidden_cookie">
            <p>By using this site, you agree our use of cookies to store necessary information. Please <a
                    id="acceptCookies" href="#">accept</a> before using our site.</p>
        </div>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="container">
                        <div class="carousel-caption text-start">
                            ...
                            <p>Our mission is to ensure that nobody lacks the help they need, regardless of social or
                                economic status.</p>
                            <p><a class="btn btn-lg btn-primary" href="newSignup.php">Sign Up Today</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    ...
                    <div class="container">
                        <div class="carousel-caption text-end">
                            ...
                            <p><a class="btn btn-lg btn-primary" href="newSignup.php">Start Now</a></p>
                        </div>
                    </div>
                </div>
            </div>
